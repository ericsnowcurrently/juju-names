...
var tagKindTests = []struct {
	...
	{tag: "foo", err: `tags must be in the "<kind>-<id>" format, got "foo"`},
	{tag: "unit", err: `tags must be in the "<kind>-<id>" format, got "unit"`},
	{tag: "network", err: `tags must be in the "<kind>-<id>" format, got "network"`},
	{tag: "network-42", kind: names.NetworkTagKind},
	{tag: "ab01cd23-0123-4edc-9a8b-fedcba987654", err: `unsupported tag kind "ab01cd23"`},
	...
	{tag: "ipaddress", err: `tags must be in the "<kind>-<id>" format, got "ipaddress"`},
	{tag: "ipaddress-42424242-1111-2222-3333-0123456789ab", kind: names.IPAddressTagKind},
	{tag: "subnet", err: `tags must be in the "<kind>-<id>" format, got "subnet"`},
	{tag: "subnet-10.20.0.0/16", kind: names.SubnetTagKind},
	{tag: "subnet-2001:db8::/32", kind: names.SubnetTagKind},
	{tag: "space", err: `tags must be in the "<kind>-<id>" format, got "space"`},
